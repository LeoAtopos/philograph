...
const CardRenderer = (() => {
  ...
  function buildCard(phil) {
    ...
    portrait.onerror = function() {
      ...
      this.src = 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="44" height="44"><rect width="44" height="44" fill="#1a1a3e"/><text x="22" y="26" text-anchor="middle" fill="#9ca3b8" font-size="13" font-family="sans-serif">' + initials + '</text></svg>');
    };
