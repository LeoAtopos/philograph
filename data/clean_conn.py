...
# Remove connections referencing weber
conn = [c for c in conn if c['fromPhil'] != 'weber' and c['toPhil'] != 'weber']

# Also verify no other removed philosophers are referenced
...
print(f"Remaining connections: {len(conn)}")
